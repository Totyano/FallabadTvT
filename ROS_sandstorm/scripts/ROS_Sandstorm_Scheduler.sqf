...
ie. [min number of storms, max number of storms, length of storm] execvm "ROS_Sandstorm\ROS_Sandstorm_Scheduler.sqf";
...
[1, 1, 150] execvm "ROS_Sandstorm\scripts\ROS_Sandstorm_Scheduler.sqf";
...
[0, 1, 260] execvm "ROS_Sandstorm\scripts\ROS_Sandstorm_Scheduler.sqf";

Example 3: run from 0 to 4 storms from current time to 24:00 with random storm length (0) ie. 20% chance of 0,1,2,3,4 storms
[0, 4, 0] execvm "ROS_Sandstorm\scripts\ROS_Sandstorm_Scheduler.sqf";
-----------------------------------------------------------------------------------------------------------------------------------------
